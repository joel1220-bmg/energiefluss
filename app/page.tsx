...
export default function HomePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 pb-20 pt-10 sm:pt-16">
      ...
      <h1 className="serif mt-3 max-w-[24ch] text-[2.05rem] leading-[1.15] text-forest sm:text-5xl">
        {COPY.landingLead}
      </h1>
      ...
      <ol className="mt-14 grid gap-4 sm:grid-cols-3">
        {(
          [
            [COPY.landingTileFour, COPY.landingTileFourBody],
            [COPY.landingTileSize, COPY.landingTileSizeBody],
            [COPY.landingTileCost, COPY.landingTileCostBody],
          ] as const
        ).map(([t, d]) => (
